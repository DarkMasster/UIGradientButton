...
{
    internal class CWParticlesUnlitShader : BaseShaderGUI
    {
        // Properties
        ...
        public override void DrawBaseProperties(Material material)
        {
            if (baseMapProp != null && baseColorProp != null) // Draw the baseMap, most shader will have at least a baseMap
            {
                ...
                materialEditor.TextureProperty(baseMapProp, Styles.baseMap.text );
                materialEditor.ColorProperty(baseColorProp, Styles.baseMap.text + " Color" );
            }
        }
